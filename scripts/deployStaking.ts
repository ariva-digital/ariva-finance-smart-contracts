...
async function main(): Promise<void> {
  ...
  const staking: Contract = await upgrades.deployProxy(StakingFactory, [params.token, params.lockupDuration], {
  ...
  await hre.run("verify:verify", {
    ...
    constructorArguments: [params.token, params.lockupDuration],
  });
}
